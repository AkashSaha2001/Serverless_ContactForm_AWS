document.getElementById('contact-form').addEventListener('submit', function(event) {
  ...
  function submitForm(formData) {
    ...
    fetch('https://aa510482h9.execute-api.ap-south-1.amazonaws.com/dev/submit', { // URL that represents the backend API endpoint to which the form data is going to be sent
      method: 'POST',
      headers: {
